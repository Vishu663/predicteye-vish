...
"[project]/src/app/api/chats/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const service = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].service.findUnique({
            where: {
                id: serviceId
            }
        });
        if (!service) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error(`Service not found: ${serviceId}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const chat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.create({
            data: {
                userId,
                serviceId,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`New chat created: ${chat.id} for service: ${serviceId} by user: ${userId}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            chat,
            block: chat.blocks[0]
...
//# sourceMappingURL=src_c45849._.js.map