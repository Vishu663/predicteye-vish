...
async function POST(request) {
    try {
        ...
        const userCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.count();
        let existingUser = null;
        if (userCount > 0) {
            existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
                where: {
                    email
                }
            });
        ...
        // Create new user
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
            data: {
                name,
                email,
                password: hashedPassword,
                image: `/placeholder.svg?height=50&width=50`,
                provider: __TURBOPACK__commonjs__external__$40$prisma$2f$client__["AuthProvider"].Local
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=src_8984b5._.js.map