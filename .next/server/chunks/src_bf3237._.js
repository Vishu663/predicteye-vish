...
"[project]/src/app/api/predict/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
async function POST(request) {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2f$auth$2d$options$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
        ...
        if (chat.service?.name?.toLowerCase().includes("jewelry")) {
            ...
            if (targetBlock) {
                ...
                const materialMessage = targetBlock.messages.find((message)=>message.role === "user" && [
                        "Gold",
                        "Silver",
                        "Platinum",
                        "White Gold",
                        ...
                        "Stainless Steel",
                        "Other"
                    ].some((type)=>message.content.toLowerCase().includes(type.toLowerCase())));
                materialType = materialMessage?.content || "Gold";
                // Extract weight
                const weightMessageIndex = targetBlock.messages.findIndex((message)=>message.role === "assistant" && message.content.toLowerCase().includes("gram"));
                if (weightMessageIndex !== -1 && targetBlock.messages[weightMessageIndex + 1]) {
        ...
        let prompt = "Please predict the resale value for this item based on the following details in conversation format:\n\n";
        let image = null;
      ...
      `;
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${process.env.GEMINI_API_KEY}`, {
            contents: [
                {
                    parts: [
                        {
        ...
        if (jsonStartIndex !== -1 && jsonEndIndex !== -1) {
            ...
            try {
                ...
                predictionJson = {
                    error: "Invalid JSON format in prediction"
                }; // Fallback JSON structure
            }
        } else {
            console.error("No valid JSON found in prediction text");
            predictionJson = {
                error: "No JSON found in prediction"
            }; // Fallback JSON structure
        }
        ...
        const structuredResponse = {
            success: true,
            prediction: {
                text: predictionText.split("```json")?.[0] || "",
                json: {
                    ...predictionJson,
                    chatId,
                    blockId,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].block.update({
            where: {
                id: blockId
            },
            data: {
        ...
        if (chat.title === "New Chat" && structuredResponse.prediction.json?.chat_name) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.update({
                where: {
                    id: chatId
                },
                data: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(structuredResponse);
    } catch (error) {
...
//# sourceMappingURL=src_bf3237._.js.map